...
def get_args():
    ...
    parser.add_argument('--model', type=str, default='HTCN', choices=['HAN', 'Conv_GRNN', 'HAHNN', 'TextCNN', 'DPCNN', "HAHNN_TCN", "HAN_TCN", "HTCN"])
    parser.add_argument('--paralell', type=bool, default=True)
